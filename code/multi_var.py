    ...
    for config in configs["models"]:
        ...
        if extended_data:
            ...
            for i in range(4):
                ...
                print("***********************************************************************************************************")
                print(xy_train_i, xy_valid_i, xy_test_i, xy_noisy_i, xy_clean_i, gx_gy_i, indices_i)
        ...
        # # scale the data
        # x_noisy_train = scaler.fit_transform(x_noisy_train.reshape(-1, x_noisy_train.shape[-1])).reshape(x_noisy_train.shape)
        # x_noisy_valid = scaler.transform(x_noisy_valid.reshape(-1, x_noisy_valid.shape[-1])).reshape(x_noisy_valid.shape)
        # x_clean_train = scaler.fit_transform(x_clean_train)
        # x_clean_valid = scaler.transform(x_clean_valid)
...
####### evaluate model robustness
        ...
        print("epsilon is ")
        test_noise_model = NoiseGenerator(num_samples=x_len, num_noises=num_noises, noise_type=distribution, percentage=percentage, epsilon=epsilon)
        ...
        for idx, model in enumerate(models):
            ...
            model_i_res_folder = f"{models_folder}/rm_results_laplace/model_{idx+1}"
...
if __name__ == '__main__':
    ...
    json_files = [
        ...
        # "I_27_6.json",
        # "I_18_12.json",
        # "I_32_5.json", #rerun - done
        # "I_34_8.json", #rerun- done
        # "I_15_3t.json", nan
        # "II_8_31.json", # custom stops early - done
        # "II_11_20.json", #rerun noise-aware
        # "II_8_7.json",
        # "II_27_16.json", error is always inf
        # "II_27_18.json", #custom stops early
        # "I_50_26.json",
        # "III_8_54.json",
        "I_6_2.json",
        # "I_6_2a.json",
