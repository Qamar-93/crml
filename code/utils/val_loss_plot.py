...
for eq in eqs:
    ...
    with open(f'/home/qamar/workspace/crml/code/results_dp/results_custom_dp_{eq}/linear/{type}/models_all/valid_losses_all_epochs.txt', 'r') as f:
        lines = f.readlines()
    ...
    with open(f'/home/qamar/workspace/crml/code/results_dp/results_mse_dp_{eq}/linear/{type}/models_all/valid_losses_all_epochs.txt', 'r') as f:
